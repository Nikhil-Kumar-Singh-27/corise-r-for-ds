...
tbl_names <- readr::read_csv(file_name, show_col_types = TRUE)
...
tbl_lifetables <- readr::read_csv(file_name_names, show_col_types = TRUE)
#> Rows: 5040 Columns: 9
...
plot_estimated_age <- function(tbl, my_name, my_sex) {
  tbl |> 
    ...
    geom_line(aes(y=nb_births), color = "blue") +
...
tbl_names_extended_age |> 
  ...
  labs(
    ...
    subtitle = "Avg age for Female names",
    x = "Median Age",
    y = "Name"
  ) +
