...
tbl_names_by_letter |> 
  ...
  ggplot(aes(y=pct_births, x=first_letter)) +
  ...
  labs(
      title = "Percentage of babies per first letter",
      subtitle = "Year 2020",
      x = 'First Letter',
      y = '% babies'
    ) +
...
tbl_names_by_first_and_last_letter |> 
 ...
 labs(
      title = "Frequency of combinations" ,
      caption = "First vs Last",
...
tbl_names_vowel_consonant |> 
  ...
  facet_wrap(~ sex, scales = "free_y") +
  # Add labels (title, subtitle, caption, x, y)
  labs(title = "Percentage of births by combo of", 
       subtitle = "First vs Last letter type", 
       caption = "Source : Unknown", 
       x = "Year", 
       y =  "Births (%)" ) +
